        ...
        <div className="flex flex-col mt-3  border-gray-400 border-8 rounded-xl">
            <div className="flex flex-row">
                ...
                <div className="flex flex-col items-center bg-gray-300">
                    <h1 className="text-xl font-bold text-amber-400 mt-2 ml-2">ENGAGEMENT/COMMUNICATION PERK</h1>
        ...
        <div className="flex flex-col mt-3 border-gray-400 border-8 rounded-xl">
            <div className="flex flex-row">
                ...
                <div className="flex flex-col items-center bg-pink-100">
                    <h1 className="text-xl font-bold text-amber-400 mt-2 ml-2">GIVEAWAYS PERK</h1>
                    <p className="text-md mt-2 ml-4 mr-4">As a paid member you get a free Member T-shirt sent to
                    you upon sign up!</p>
                    <div className="flex flex-row space-x-24 mt-2 mb-2">
                     <button className="bg-amber-400 text-black font-semibold rounded-full px-6 w-32 h-10 mt-3">Next</button>
                        <img src={box} alt="engagement" className="border-black border-2 rounded-full h-14 mt-1" />
                    </div>
                </div>
            </div>
            <div className="flex flex-col justify-start rounded-xl h-24 bg-slate-300 mt-4 mb-2 ml-2 mr-2">
